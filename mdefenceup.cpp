        ...
        if(stoi(FileLine.substr(4)) == m)
        {
          for (; i < 6; i++)
          {
            ...
            switch(i)
            {
              ...
              case 5:
              {
                MDefenceUpS = stoi(FileLine.substr(12, 1));
...
void MDefenceUp::AddToCommand(string Slot)
{
  if(Slot.substr(0, 1) == "1")
  {
    DefendCommand.ModSlot1 = Id;
  }
  else if(Slot.substr(0, 1) == "2")
  {
    DefendCommand.ModSlot2 = Id;
  }

  DefendCommand.CDefendS = DefendCommand.CDefendS + MDefenceUpS;

  cout << Name << " Mod added to Command." << endl;
}

void MDefenceUp::RemoveFromCommand(string Slot)
{
  if(Slot.substr(0, 1) == "1")
  {
    DefendCommand.ModSlot1 = 0;
  }
  else if(Slot.substr(0, 1) == "2")
  {
    DefendCommand.ModSlot2 = 0;
  }
...
void MDefenceUp::RemoveFromPlayer()
{
